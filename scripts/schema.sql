-- =====================================================================
-- SUPRA — Plataforma de Cotacoes Corporativas
-- Modelo de dados multiempresa (SaaS). Isolamento por empresa_id.
...
-- Busca full-text (FTS5) sobre 100 mil materiais
create virtual table materiais_fts using fts5(
  codigo, descricao, especificacao,
  content='materiais', content_rowid='id', tokenize='unicode61'
);
...
create virtual table fornecedores_fts using fts5(
  ...
  content='fornecedores', content_rowid='id', tokenize='unicode61'
);
